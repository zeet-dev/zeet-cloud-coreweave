...
{{- define "traefik.externalHostName" -}}
{{- if .Values.externalDns.enabled }}
{{- if .Values.externalDns.subdomainOverride }} {{ .Values.externalDns.subdomainOverride }} {{- else }} {{ .Release.Name }} {{- end }}.{{ .Release.Namespace }}-{{ .Values.region | lower }}.coreweave.cloud
{{- end }}
{{- end -}}
{{/*
...
{{- define "traefik.controllerClass" -}}
{{- if .Values.controllerClass -}}
{{- print .Values.controllerClass -}}
{{- else -}}
{{- $className := printf "%s-%s" .Release.Namespace (include "traefik.fullname" .) -}}
{{- print $className -}}
{{- end -}}
{{- end -}}